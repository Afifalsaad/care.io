            ...
            <div className="bg-background rounded-xl sm:px-6 px-4 py-8 max-w-md w-full [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] max-lg:mx-auto">
              <form onSubmit={handleLogin}>
                ...
                {/* <div className="sm:flex sm:items-start space-x-4 max-sm:space-y-4 mb-8">
                  <button
                    type="button"
                    className="py-2.5 px-4 text-sm cursor-pointer font-medium rounded-md text-blue-600 bg-blue-100 hover:bg-blue-200 focus:outline-none">
                    <svg
                  ...
                  <button
                    type="button"
                    className="py-2.5 px-4 text-sm cursor-pointer rounded-md text-blue-500 bg-blue-100 hover:bg-blue-200 focus:outline-none">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20px"
                      fill="#007bff"
              ...
              <p className="text-sm mt-6 text-center text-slate-600">
                ...
                <a className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">
                  Register here
                </a>
              </p>
            </div>
