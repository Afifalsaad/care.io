          ...
          <div className="relative h-full min-h-screen">
            <div className="flex items-start">
              ...
              <section className="main-content w-full px-6">
                <header className="z-50 sticky top-0 pt-4">
                  <div className="flex flex-wrap items-center px-6 py-2 shadow-md min-h-[56px] rounded-md w-full relative tracking-wide">
                    <div className="flex items-center flex-wrap gap-x-8 gap-y-4 z-50 w-full">
                      ...
                      <div className="flex items-center gap-8 ml-auto">
                        ...
                        <div className="dropdown-menu relative flex shrink-0 group">
                          ...
                          <div className="dropdown-content hidden group-hover:block shadow-md p-2 rounded-md absolute top-9 right-0 w-56">
